    ...
    `}>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 font-display uppercase tracking-widest">{item.title}</h3>
    ...
    <section ref={containerRef} id="roadmap" className="relative py-32 px-6 bg-dark overflow-hidden">
      <div className="text-center mb-16 max-w-2xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-muted mt-6 border-l-2 border-white/10 pl-6 mx-auto inline-block text-left">
      ...
      <div className="max-w-7xl mx-auto relative px-4 md:px-0">
        {/* The Plasma Circuit Line */}
        <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[2px] bg-white/5">
           <motion.div 
             style={{ scaleY: pathLength, transformOrigin: 'top', background: 'linear-gradient(to bottom, #00f0ff, #8b5cf6, #ff6b9d)' }}
             className="absolute inset-0 w-full shadow-[0_0_15px_#00f0ff,0_0_30px_#8b5cf6]"
           />
           
           {/* Moving Plasma Dot */}
           <motion.div 
              style={{ top: useTransform(pathLength, [0, 1], ['0%', '100%']) }}
              className="absolute left-1/2 -translate-x-1/2 w-3 h-3 bg-white rounded-full shadow-[0_0_20px_#00f0ff,0_0_40px_white] z-30"
           />
        </div>
