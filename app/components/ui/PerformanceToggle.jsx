...
export default function PerformanceToggle() {
  ...
  return (
    <motion.button
      onClick={toggleMode}
      className={`fixed top-24 right-4 md:right-8 z-[100] rounded-full px-4 py-2 text-xs font-bold font-display uppercase tracking-widest transition-all duration-300 cursor-pointer pointer-events-auto border backdrop-blur-md shadow-lg
